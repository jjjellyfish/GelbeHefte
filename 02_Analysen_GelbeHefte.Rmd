...
# Tabelle geht nicht auf, da nicht nur vorher lückenlose Hefte aufgeführt werden (daher Überführung in erst Tabelle nicht möglich)
...
Alternative mit bis zu der Stufe lückenlosen Heften:
```{r}
tbl1 <- tabyl(tmp$mis_copy[tmp$mis_copy > 0]) %>% rename(anzahl = 1) %>% add_row(anzahl=7, n=0, percent=0)
