...
tmp2 %>% kbl2(col.names= c('Grad der Lückenlosigkeit', 'n', '%[1]', '%[2]', '%[3]', '%[4]'))
```
  \linebreak

In der Tabelle dargestellte Prozentwerte: 

* [1] = Anteil an allen erhaltenen Gelben Heften <br><br>
* [2] = Anteil an allen Gelben Heften mit lückenlosen Kopien <br><br>
* [3] = Anteil an allen Gelben Heften mit lückenlosen Kopien mit Eintragungen <br><br>
* [4] = Anteil an allen Gelben Heften mit lückenlos vorhandenen Ergebnisseiten <br><br>
