...
#### Defintion: von erster U bis zur letzten U
(Definition Lückenlosigkeit: zwischen der ersten und der letzten **vorliegenden** U-Untersuchung fehlt eine)

```{r Lueckenlosigkeit_Heft_Def1, echo=FALSE, warning=FALSE, message=FALSE}
### data prep
...
lueckl_heft_def1 <- tmp
```


```{r Lueckenlosigkeit_Heft_Def1_output}
tmp <- lueckl_heft_def1 %>% 
  filter(u_nr == u_min) %>%
...
```{r Lueckenlosigkeit_Heft_Def1_fehlendeUs, warning=FALSE, message=FALSE}
tmp <- lueckl_heft_def1
...
#### Defintion: von U2 bis zur letzten U
(Definition von Lückenlosigkeit: zwischen der U2 und der letzten vorliegenden U-Untersuchung fehlt eine)
