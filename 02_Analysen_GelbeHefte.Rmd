...
# 4. Ergebnisse der Evaluation von Anlage 1 (Untersu-chungsheft für Kinder) der Kinder-Richtlinie
...
tmp <- left_join(tmp, tmp2)
### to do!!! ####
# es muss eigentlich nicht nur eine Kopie vorliegen (Eltern könnten ja mehr Kopien mitgeschickt haben)
# erst wenn auch eien Eintragung vorliegt, kann davon ausgegangen werden, dass die U7 auch wirklich die 
# letzte U-Untersuchung war
...
  \linebreak
In wie vielen Heften fehlen wie viele U-Untersuchungen? (Unterteilt danach, an welcher Stufe das Fehlen auftritt. Bei jeder folgenden Stufe werden nur Gelbe Hefte berücksichtigt, die bis dahin lückenlos waren.)
