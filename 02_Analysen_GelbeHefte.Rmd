...
```{r Lueckenlosigkeit_plot, message=FALSE, warning=FALSE}
tmp <- lueckl %>% 
...
  \linebreak
In wie vielen Heften fehlen wie viele U-Untersuchungen? (Unterteilt danach, bei welcher Stufe das Fehlen auftritt. Bei jeder folgenden Stufe werden nur Gelbe Hefte berücksichtigt, die bis dahin lückenlos waren.)
...
Welche spezifischen U-Untersuchungen fehlen wie häufig?  (Unterteilt danach, bei welcher Stufe das Fehlen auftritt. Bei jeder folgenden Stufe werden nur Gelbe Hefte berücksichtigt, die bis dahin lückenlos waren.)
